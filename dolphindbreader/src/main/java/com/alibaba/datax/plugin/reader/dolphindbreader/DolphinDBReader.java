...
public class DolphinDBReader extends Reader {
    ...
    public static class Job extends Reader.Job {
        ...
        public void init() {
            ...
            int fetchSize = this.originalConfig.getInt(com.alibaba.datax.plugin.rdbms.reader.Constant.FETCH_SIZE, Constant.DEFAULT_FETCH_SIZE);
            if (Constant.DEFAULT_FETCH_SIZE < fetchSize && fetchSize < Constant.MIN_FETCH_SIZE) {
                throw DataXException.asDataXException(DBUtilErrorCode.REQUIRED_VALUE,
                        String.format("您配置的fetchSize有误，根据DolphinDB的设计，fetchSize : [%d] 设置值不能小于 8192.", fetchSize));
            }
